...
load("developing_se/K562_se/se_K562.rda")
...
```{r}
#Load the `se` object for HEPG2
load("developing_se/HEPG2_se/se_HEPG2.rda")
#Labels for non-coding RNA
nc_labels <- c("lncRNA")
#Labels for coding RNA
c_labels <- c("protein_coding")
