...
Another exciting route we can take is examing how the two cell types compare against each other across RBPs they share. Here we found 75 RBPs used in both cells!
```{r}
#K562 Cell Line
