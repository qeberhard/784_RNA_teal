...
```{r}
counts <- read.csv("developing_se/HEPG2_se/HEPG2_count_file.tsv", sep="\t")
column_data <- read.csv("developing_se/HEPG2_se/column_data_HEPG2.tsv", sep="\t")
...
save(se, file = "derived_data/se_HEPG2.rda")
```
...
se2 <- se[keep2,]
save(se2, file = "derived_data/se2_HEPG2.rda")
