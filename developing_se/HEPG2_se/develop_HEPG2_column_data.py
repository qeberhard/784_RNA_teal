...
with open("../downloaded_files/HEPG2_metadata.tsv", "r") as metadata_file:
...
with open("bam_only_file.tsv", "r") as bam_infile:
    with open("column_data_HEPG2_inbetween.tsv", "w") as colout_file:
...
with open("../featurecounts/main_featcount_file.tsv", "r") as ordered:
    ...
    counter = 0
with open("column_data_HEPG2_inbetween.tsv", "r") as unordered_file:
    unordered_lines = unordered_file.readlines()
    print(len(unordered_lines))
    with open("column_data_HEPG2.tsv", "w") as outfile:
