...
png(file="~/BCB784_proj/784_RNA_teal/developing_se/K562_se/PheatMap_lncRNA_v_proteinCoding_plot.png",
    width=2000, height=1200)
pheatmap(se_assay[1:135], cluster_rows=F, show_rownames=F,
         cluster_cols=F, main = "Pheat map of K562 linc vs protein coding", border_color = T,annotation_row = Anno,
